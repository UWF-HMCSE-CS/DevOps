...
sudo docker cp /home/ec2-user/workspace/jenkins_pipeline/$1/Index/index.html pipeline_stage:/var/www/html/java_stage/$1/index.html
(cd  /home/ec2-user/workspace/jenkins_pipeline/$1; sudo zip java.zip /home/ec2-user/workspace/jenkins_pipeline/$1/target/*.jar)
